...
/* Maximum Connection Interval acceptable for HID Mouse*/
#define MAX_CI_ACCEPT   12
/* Slave Latency */
...
wiced_bt_gatt_status_t app_bt_gatt_get_attr_value( uint8_t attr_handle_index,
                                                uint8_t *p_val,
                                                uint16_t len,
                                                uint16_t *p_len);
